	...
	<div class="container">
		...
		<div class="col-md-6">
			...
			<div class="form-group">
				...
				<input type="submit" name="addbatsman" class="btn btn-primary  addbowlerrating">
			</div>
		</div>
	</div>
</section>
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('.addbowlerrating').click(function(event){
			var batsman = $('select[name="bowler"]').val();
